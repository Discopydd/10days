...
bool LevelSelectScene::Update() {
	...
	if (input_->TriggerKey(DIK_1)) { requestedScene_ = SceneType::kGame; isDecisionMade = true; }
	if (input_->TriggerKey(DIK_2)) { requestedScene_ = SceneType::kSwing; isDecisionMade = true; }
	if (input_->TriggerKey(DIK_3)) { requestedScene_ = SceneType::kThird; isDecisionMade = true; }
